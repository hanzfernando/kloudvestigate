    ...
    >
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <section className="panel">
            ...
            <pre className="mt-4 max-h-180 overflow-auto rounded border border-border-subtle bg-surface p-4 text-xs leading-5">
          ...
          <section className="grid gap-4">
            <div className="panel">
              ...
              <pre className="mt-4 max-h-105 overflow-auto whitespace-pre-wrap rounded border border-border-subtle bg-surface p-4 text-xs leading-5">
            ...
            <div className="panel">
              ...
              <div className="mt-4 rounded border border-border-subtle bg-surface p-4 text-sm leading-6">
